...
**Encoder Settings**:
User-visible GPU Screen Recorder knobs in Settings (codec, fps, quality, and similar). Hidden behind the collapsed Encoder section. Clip Resolution, Clip Layout, and Cursor live in Config with Replay Window and audio.
