...
**Encoder Settings**:
User-visible GPU Screen Recorder knobs in Settings (codec, fps, quality, cursor, and similar). Hidden behind the collapsed Encoder section. Clip Resolution and Clip Layout live in Config with Replay Window and audio.
