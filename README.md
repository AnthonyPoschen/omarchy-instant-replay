...
Left-click the bar icon. Save clip and Open clips stay on the main surface. Replay Window, audio, output folder, resolution, layout, and cursor are under Replay; Mode is under Recording region; encoder knobs are under Encoder. All three sections start collapsed. An expanded section ends with a divider.
