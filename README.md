...
Left-click the bar icon. Save clip and Open clips stay on the main surface. Mode is under Recording region; Replay Window, audio, output folder, resolution, layout, and cursor are under Config; encoder knobs are under Encoder. All three sections start collapsed.
