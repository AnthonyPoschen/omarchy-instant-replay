...
Only one KMS capture can run. This plugin launches GPU Screen Recorder as `omarchy-shadowplay-gsr` so stock Omarchy screenrecord does not treat the Replay Buffer as a session recording and stop it.
